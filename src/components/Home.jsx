...
import { homePageName, homePageDescription, homePageTitle } from '../data/data'
  ...
  return (
    <div name="Home" className='w-full min-h-screen bg-[#0a192f] flex flex-col justify-center pt-[80px]'>
      ...
      <div className='max-w-[1000px] mx-auto h-full flex flex-col justify-center px-8'>
        ...
        <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>{homePageName}</h1>
        <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>{homePageTitle}</h2>
        <p className='text-[#8892b0] py-4 max-w-[700px]'>{homePageDescription}</p>
